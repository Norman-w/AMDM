...
{
    public partial class ModbusConnectTest : Form
    {
        ...
        public ModbusConnectTest()
        {
            InitializeComponent();
        }
        private void Form1_Load(object sender, EventArgs e)
        {
            cmb_portname.SelectedIndex = 2;
            cmb_baud.SelectedIndex = 7;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                //初始化串口参数
                var port = InitSerialPortParameter();
                ModbusFactory fc = new ModbusFactory();
                master = ModbusFactoryExtensions.CreateRtuMaster(fc, port);
                //ts = ModbusFactoryExtensions.CreateRtuTransport(fc, port);
                
                //MS ms = new MS();
                //ts.BuildMessageFrame(ms);
        ...
        //IModbusSlaveNetwork network = null;
        //IModbusTransport ts = null;
        //public class MS :IModbusMessage
        //{
        //    // 摘要: 
