...
namespace AMDMClientSDK.Domain
{
    ...
    /// 获取交付记录信息
    /// </summary>
    public class DeliveryRecordsGetResponse : NetResponse
    {
        /// <summary>
        /// 总共有多少条数据
        /// </summary>
        ...
        /// 获取到的交付记录的集合
        /// </summary>
        public List<AMDM_Domain.AMDM_DeliveryRecord> DeliveryRecords { get; set; }
    }
    #endregion
    ...
    /// 获取交付记录信息
    /// </summary>
    public class DeliveryRecordsGetRequest : BaseRequest<DeliveryRecordsGetResponse>
    {
        public DeliveryRecordsGetRequest()
        {
            this.Fields = "*";
            this.PageNum = 0;
            this.PageSize = 100;
        ...
        /// <summary>
        /// 如果需要指定获取完成或者没完成的交付单 指定此参数
        /// </summary>
        public Nullable<bool> FinishStatus { get; set; }
        /// <summary>
