...
namespace QP.SqlClient
{
    ...
    public class MysqlClient
    {
        ...
        public int port;
        public MysqlClient(string ip, string user, string pass, string database, int port)
        {
            this.ip = ip;
            this.user = user;
            this.pass = pass;
        ...
        public int UpdateDatas(SqlObjectUpdaterParamters pr)
        {
            ...
            if (dic.Count == 0)
            {
                ...
                try
                {
                    prJson = Newtonsoft.Json.JsonConvert.SerializeObject(pr);
                }
